...
export default function GMICaseStudy() {
  ...
  return (
    ...
    {/* <MetaUpdate
      ...
      <CaseStudyHeroSection className="hero-section theme-bg-gmi-primary" >
        <div className="container">
          <div className="equal-padding-T  ">
            <CaseStudyHeroWrap>
              <h1 className="h2 section-head">AI Powered Leadership Development
              and Assessment Platform</h1>
              <CategoriesList className="anim-bottom-box ">
                <h6>How did we help: </h6>
                <ul style={{ "--list-color": "var(--gmi-cs-secondary)" }}>
              ...
              <div className="equal-padding-B col-lg-11 mx-auto">
                ...
                <div className="row gy-4">
                  ...
                  <div className="col-xl-7 col-lg-6 anim-right-box">
                    <p className="sub-head mb-0">Great Manager Institute is an organization dedicated to helping companies measure and develop their people leaders at scale using our AI-powered people leadership assessment and development platform for people managers. <br /> <br />
                    GMI trusted us with their unique vision. Together, we'll continue to create digital experiences that inspire, engage, and leave a lasting impression!</p>
                  </div>
                </div>
              </div>
