...
export default function EquizenCaseStudy() {
  ...
  const [siteTitle, setSiteTitle] = useState("Hybreed.co | Equizen Case Study");
  const [siteDesc, setSiteDesc] = useState("Equizen is a distinguished financial advisory firm founded on the principles of transparency and client-centricity.");
  const [siteUrl, setSiteUrl] = useState(window.window.location.href);

  useEffect(() => { 
    setTimeout(()=>{

      setSiteTitle("Hybreed.co | Equizen Case Study");
      setSiteDesc("EquiZen is a distinguished financial advisory firm founded on the principles of transparency and client-centricity.");
      setSiteUrl(window.window.location.href);
  ...
  return (
      ...
      pageUrl={setSiteUrl}
       ...
       <meta name="keywords" content="Equizen, Equizen Case Study, Equizen Website Design, Equizen Website Development, Equizen Branding, Equizen Logo Design, Equizen Illustration" />
       <meta property="og:title" content={siteTitle} />
       <meta property="og:description" content={siteDesc} />
       <meta property="og:url" content={siteUrl} />
       <link rel="canonical" href={siteUrl} />
       <meta property="og:site_name" content="Hybreed.co" />
       <meta property="og:type" content="website" />
       <meta name="twitter:card" content="summary_large_image" />
       <meta name="twitter:title" content={siteTitle} />
       <meta name="twitter:description" content={siteDesc} />
       <meta name="twitter:url" content={siteUrl} />
       <meta name="twitter:site" content="Hybreed.co" />
       <meta name="twitter:creator" content="@Hybreed.co" />
