...
export default function Index({ data }) {
  ...
  return (
    <>
      ...
      <MarqueeItems dataList={data} repeatData={repeatItems} />
...
export const MarqueeItems = ({ dataList, repeatData }) => {

  const filteredItems1 = dataList?.filter(item => item.itemCategory === 1);
  const filteredItems2 = dataList?.filter(item => item.itemCategory === 2);
  const filteredItems3 = dataList?.filter(item => item.itemCategory === 3);
